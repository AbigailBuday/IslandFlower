        ...
        */
        ...
        var glpro = {
            ...
            f: {
                ...
                getSettings: async function () {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        //   fetch("https://gkt102.pagekite.me/api/cartSettings/get?shopName=ashfaq-may-store.myshopify.com",{
                ...
                getSettingsFromS3: async function () {
                    ...
                    console.log("GET setting of giftlab pro fired")
                    return new Promise(function (resolve, reject) {
					    fetch(`https://giftwrap-and-msgs.s3.us-east-2.amazonaws.com/tempCartSettings/${shopName}.json`,{
                            method: 'GET',
                            }).then(
                                response => response.json() // if the response is a JSON object
                            ).then(
            ...
            glproGiftMessageV2: {
                ...
                f:{
                    prepareUI : function () {
                        console.log("TESTINNNNNNNNNNNNGGGGGG123456789")
                    ...
                    isMessagePresent: function(){
                        try{
                            ...
                            console.log("error in isMessagePresent",e)
                            return false
                        }  
                    ...
                    isVideoPresent: function(){
                        try{
                            ...
                            console.log("error in isVideoPresent",e)
                            return false
                        }
